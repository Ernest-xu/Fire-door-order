<?php
	...
	//echo $id;
	$sql = "update dagang_order_approve set code='$code',project_name='$project_name',contact_person='$contact_person',project_addr='$project_addr',contact_tel='$contact_tel',supply_dt='$supply_dt',req1_1='$req1_1',req1_2='$req1_2',req1_3='$req1_3',req1_4='$req1_4',req1_5='$req1_5',req1_6='$req1_6',req2_1='$req2_1',req2_2='$req2_2',req2_3='$req2_3',req2_4='$req2_4',req2_5='$req2_5',req2_6='$req2_6',fix_1=$fix_1,fix_2=$fix_2,fix_3=$fix_3,fix_4=$fix_4,package_way1=$package_way1,package_way2=$package_way2,package_material1=$package_material1,package_material2=$package_material2,package_material3=$package_material3,fix_arrange='$fix_arrange',attachment_desc='$attachment_desc',special_req='$special_req'  where id=$id";
	$rs = $mysqli->query($sql);
	if($rs){
