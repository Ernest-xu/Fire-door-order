...
<body>	
	...
	<script type="text/javascript">	
			...
			$('#pd_detail').datagrid({
				...
				{field:'postage',title:'包邮',width:50,align:'center',formatter:function(value, row){if (value==0) {return '';} else if(value==1){return '包邮';}},editor:{type:'checkbox',options:{on:'1',off:'0'}}},
				...
				{field:'company_name',title:'企业名称',width:80,align:'center'},
				{field:'action',title:'操作',width:80,align:'center',
					formatter:function(value,row,index){
						...
						if (row.editing){
							...
							var d = '<a href="javascript:void(0)" onclick="mpl_deleterow(this)">删除</a>';
							//return e+d;
							return e;
						}
					}
