...
<body>	
	...
	合同编号：<input id="dcl_code" name="contract_code" class="easyui-textbox" style="width:300px" required="true"></input><br/><br/>
	公程名称：<input id="dcl_name" name="project_name" class="easyui-textbox" style="width:300px" required="true"></input>
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add"  onclick="dcl_cl_new()" style="width:90px">新增</a>
	</form>
	</div><br/>
	<table id="dcl_contract_list"  style="width:620px;height:400px" ></table>
	...
	$(function(){
			...
			$('#dcl_contract_list').datagrid({
				...
				{field:'contract_code',title:'合同编号', width:80,align:'center'},
				{field:'project_name',title:'工程名称', width:80,align:'center'},
				{field:'jiaohuo_dt',title:'交货时间', width:80,align:'center'},
				{field:'jianshe_team',title:'建设单位', width:80,align:'center'},
				...
				{field:'action1',title:'详细',width:100,align:'center',
				...
				{field:'action2',title:'删除',width:100,align:'center',
					formatter:function(value,row,index){
	...
	<div id="dcl_contract_dlg" class="easyui-dialog" style="width:800px;height:600px;padding:20px 50px" closed="true">
	<div class="easyui-panel" title="公司执照编辑" style="width:700px;height:270px;padding:20px 20px;">
	<form id="dcl_dcl_ffrom" class="easyui-form" method="post">
		签订时间: <input name="sign_dt" class="easyui-datebox" style="width:220px;" required="true" editable=false/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合同编号: <input name="contract_code" class="easyui-textbox" style="width:220px;" required="true"/><br/> <br/>
		工程名称: <input name="project_name" class="easyui-textbox" style="width:220px;" required="true"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交货日期: <input name="jiaohuo_dt" class="easyui-datebox" style="width:220px;" required="true" editable=false/><br/> <br/>
		建设单位: <input name="jianshe_team" class="easyui-textbox" style="width:220px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售人员: <input name="sales_name" class="easyui-textbox" style="width:220px;"/><br/> <br/>
		工程地址: <input name="project_addr" class="easyui-textbox" style="width:220px;" />&nbsp;&nbsp;&nbsp;&nbsp;工程联系人: <input name="project_contact" class="easyui-textbox" style="width:220px;" /><br/><br/>
		备注: <input name="_note" class="easyui-textbox" style="width:420px;height:50px;"  data-options="multiline:true" /><br/><br/>
		说明: <input name="_note2" class="easyui-textbox" style="width:420px;height:50px;" data-options="multiline:true" /><br/><br/>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok " onclick=" dcl_savefrom()" style="width:90px">保存</a>
	...
	function dcl_cil_new(){
		...
		$.ajax({
                 type: "POST",
                 url: "dagang_contract/insert_ci_list.php?id="+cl_id,//在这里传用户id
                // data: JSON.stringify({'code': $('#recommand_code').val()}),						
	...
	var dcl_r=0;
        ...
        {     
            ...
            $.ajax({
			    type: "POST",
				contentType: "application/json; charset=utf-8",	
                url: "dagang_contract/update_contract_information.php",
                dataType: "json",				
