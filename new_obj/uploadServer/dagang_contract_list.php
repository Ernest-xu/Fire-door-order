...
<body>	
	...
	<div id="dcl_contract_dlg" class="easyui-dialog" style="width:860px;height:600px;padding:20px 50px" closed="true">
	<div class="easyui-panel" title="公司执照编辑" style="width:760px;height:270px;padding:20px 20px;">
